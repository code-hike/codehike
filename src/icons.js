...
export function CodeSandboxIcon({ size = "1em", ...props }) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function DocsIcon({ size = "1em", ...props }) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function GitHubIcon({ size = "1em", ...props }) {
  return (
    <svg
      stroke="currentColor"
      fill="none"
...
export function PauseIcon({ size = "1em", ...props }) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function LeftIcon({ size = "1.5em", ...props }) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
export function RightIcon({ size = "1.5em", ...props }) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
